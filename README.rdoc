...
= sorcery
This branch of sorcery is my attempt at DataMapper compatibility. 
The adapter is working for my needs, however, I would not reccomend using it without careful oversight.
Ideally, we can get a decent adapter together soon.
